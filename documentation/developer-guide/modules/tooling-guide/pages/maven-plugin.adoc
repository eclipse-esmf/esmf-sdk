...
| `applicationId` | Use this param for provide application id. | `String` | none | {nok}
| `channelAddress` | Use this param make possible provide channel address. | `String` | none | {nok}
| `useSemanticApiVersion` | Use the complete semantic version of the Aspect Model as the version of the Aspect API. | `Boolean` | `false` | {nok}
