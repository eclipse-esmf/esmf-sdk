...
It is possible to change predefined sections of the generated classes by providing custom https://velocity.apache.org/[Velocity] template http://people.apache.org/~henning/velocity/html/ch07.html[macros].
...
| Copyright Licence Header | copyrightHeader | {nok}
|===
