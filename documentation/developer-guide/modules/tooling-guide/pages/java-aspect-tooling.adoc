...
that specifies an Aspect regarding to the https://github.com/asyncapi/spec/[AsyncApi specification].
The currently used versions corresponds https://json-schema.org/specification-links.html#draft-4[Draft 4] of the JSON Schema specification,
and https://github.com/asyncapi/spec/blob/master/spec/asyncapi.md[3.0.0].
