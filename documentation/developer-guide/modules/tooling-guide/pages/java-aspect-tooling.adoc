...
`esmf-test-resources` module. Add a static import to
`org.eclipse.esmf.test.AspectModelAsserts.assertThat` to your test code, then you can use custom
fluent assertions similar to the `SammBuilder`, for asserting properties of an Aspect Model:
