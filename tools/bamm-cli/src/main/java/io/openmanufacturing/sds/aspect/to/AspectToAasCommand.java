...
@CommandLine.Command( name = AspectToAasCommand.COMMAND_NAME,
...
public class AspectToAasCommand extends AbstractCommand {
   ...
   @CommandLine.Option( names = { "--format", "-f" }, description = "The file format the AAS is to be generated. Valid options are \"" + AASX
         + "\" and \"" + XML + "\". Default is \"" + XML + "\"." )
