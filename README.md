...
Contains the parts of the Java implementation of the BAMM that are specific to the static variant, e.g. common base classes of static meta model elements.
