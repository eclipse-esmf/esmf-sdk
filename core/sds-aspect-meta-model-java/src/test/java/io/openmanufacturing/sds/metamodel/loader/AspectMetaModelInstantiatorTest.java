...
public class AspectMetaModelInstantiatorTest extends MetaModelInstantiatorTest {
   ...
   public void testPropertyInstantiationExpectSuccess( final KnownVersion metaModelVersion ) {
      final AspectModelUrn expectedAspectModelUrn = AspectModelUrn
            .fromUrn( TestModel.TEST_NAMESPACE + "testProperty" );
      ...
      assertThat( property.getExampleValue().get() ).isEqualTo( "Example Value" );
   ...
   public void testSingleEntityCharacteristicInstantiationExpectSuccess( final KnownVersion metaModelVersion ) {
      final AspectModelUrn expectedAspectModelUrn = AspectModelUrn
            .fromUrn( TestModel.TEST_NAMESPACE + "EntityCharacteristic" );
   ...
   public void testAspectWithRecursivePropertyWithOptional( final KnownVersion metaModelVersion ) {
      ...
      final Property secondProperty = ((DefaultEntity) firstProperty.getCharacteristic().getDataType().get())
            .getProperties().get( 0 );
      final Property thirdProperty = ((DefaultEntity) secondProperty.getCharacteristic().getDataType().get())
            .getProperties().get( 0 );
   ...
   public void testMetaModelBaseAttributesFactoryMethod( final KnownVersion metaModelVersion ) {
      final AspectModelUrn urn = AspectModelUrn
            .fromUrn( "urn:bamm:io.openmanufacturing:aspect-model:TestAspect:1.0.0" );
      final MetaModelBaseAttributes baseAttributes = MetaModelBaseAttributes.from( metaModelVersion, urn, "someName" );

      assertThat( baseAttributes.getUrn().get() ).isEqualTo( urn );
   ...
   public void testMetaModelBaseAttributesBuilder( final KnownVersion metaModelVersion ) {
      final AspectModelUrn urn = AspectModelUrn
            .fromUrn( "urn:bamm:io.openmanufacturing:aspect-model:TestAspect:1.0.0" );
      final MetaModelBaseAttributes baseAttributes =
            MetaModelBaseAttributes.builderFor( "someName" )
      ...
      assertThat( baseAttributes.getUrn().get() ).isEqualTo( urn );
      assertThat( baseAttributes.getName() ).isEqualTo( "someName" );
      assertThat( baseAttributes.getPreferredNames() ).hasSize( 1 ).containsKey( Locale.ENGLISH )
                                                      .containsValue( "preferredName" );
      assertThat( baseAttributes.getDescriptions() ).hasSize( 1 ).containsKey( Locale.ENGLISH )
