...
public class UrnSyntaxException extends RuntimeException {
   ...
   public static final String URN_IS_MISSING_SECTIONS_MESSAGE = "The URN must consist of at least 5 sections adhering to the following schema: urn:samm:<organisation>:<optional>:<version>:<model-name>.";
