...
public record XoneViolation(
   ...
   public String violationSpecificMessage() {
      ...
      // A Xone violation can be triggered when there are zero violations: Since xone states that exactly
      // one of the linked shapes
      // must cause a violation, but when none do, this is itself a violation of the xone. In this case,
      // we can not rely on the details
