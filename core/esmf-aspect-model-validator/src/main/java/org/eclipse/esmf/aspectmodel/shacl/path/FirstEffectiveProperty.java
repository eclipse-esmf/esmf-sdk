...
/**
 * From a {@link Path}, retrieves the first reachable RDF property. In certain cases (e.g. for an
 * {@link AlternativePath}), this can actually mean more than one property, which is why the result
 * is a list.
 */
