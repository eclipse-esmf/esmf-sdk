...
public class ScalarValueEntity implements ScalarValue {
   private final Object value;
   private final Scalar type;

   public ScalarValueEntity(final Object value, final Scalar type ) {
      this.value = value;
      this.type = type;
   }
   ...
   public String toString() {
      return new StringJoiner( ", ", ScalarValueEntity.class.getSimpleName() + "[", "]" )
            .add( "value=" + value )
            .add( "typeUri='" + type + "'" )
            .toString();
   }
   ...
   public boolean equals( final Object o ) {
      ...
      final ScalarValueEntity that = (ScalarValueEntity) o;
