...
/**
 * Interface to allow interested parties to do structured formatting of RDF documents (for example
 * syntax highlighting). Methods by default all return the original token.
 */
