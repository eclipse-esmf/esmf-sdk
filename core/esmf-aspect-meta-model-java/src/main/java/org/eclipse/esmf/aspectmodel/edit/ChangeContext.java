...
/**
 * The ChangeContext encapsulates the functionality provided to {@link Change} implementations to
 * access the current set of Aspect Model Files and indicate changes.
 */
