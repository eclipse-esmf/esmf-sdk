...
class AsyncApiTest extends MetaModelVersions {
   ...
   private static final String TWIN_ID = "789-012";
   ...
   void testAsyncApiGeneratorEmptyAspect( final KnownVersion metaModelVersion ) throws IOException {
      ...
      final JsonNode json = asyncApiGenerator.applyForJson( aspect, false, "", TENANT_ID, TWIN_ID, Locale.ENGLISH );

      final JsonNode expectedJson =  OBJECT_MAPPER.readTree( "{\"asyncapi\":\"3.0.0\",\"id\":\"\",\"info\":{\"title\":\"Test Aspect MQTT API\",\"version\":\"v1\",\"description\":\"This is a test description\"},\"defaultContentType\":\"application/json\",\"channels\":{\"Aspect\":{\"address\":\"/123-456/789-012/org.eclipse.esmf.test/1.0.0/Aspect\",\"description\":\"This channel for updating Aspect Aspect.\",\"parameters\":{\"namespace\":\"org.eclipse.esmf.test\",\"version\":\"1.0.0\",\"aspect-name\":\"Aspect\"},\"massages\":{}}},\"operations\":{},\"components\":{\"messages\":{},\"schemas\":{}}}" );
   ...
   void testAsyncApiGeneratorAspectWithEvent( final KnownVersion metaModelVersion ) {
      ...
      final String expectedChannels =  "{\"AspectWithEvent\":{\"address\":\"/123-456/789-012/org.eclipse.esmf.test/1.0.0/AspectWithEvent\",\"description\":\"This channel for updating AspectWithEvent Aspect.\",\"parameters\":{\"namespace\":\"org.eclipse.esmf.test\",\"version\":\"1.0.0\",\"aspect-name\":\"AspectWithEvent\"},\"massages\":{\"SomeEvent\":{\"$ref\":\"#/components/massages/SomeEvent\"}}}}";
      ...
      assertThat( json.get( "components").get( "messsages" ).get( "SomeEvent" ).toString() ).contains( expectedComponentsMessages );
      assertThat( json.get( "components").get( "schemas" ).get( "SomeEvent" ).toString() ).contains( expectedComponentsSchemas );
   }
   ...
   void testAsyncApiGeneratorAspectWithOperation( final KnownVersion metaModelVersion ) {
      ...
      final String expectedChannels =  "{\"AspectWithOperation\":{\"address\":\"/123-456/789-012/org.eclipse.esmf.test/1.0.0/AspectWithOperation\",\"description\":\"This channel for updating AspectWithOperation Aspect.\",\"parameters\":{\"namespace\":\"org.eclipse.esmf.test\",\"version\":\"1.0.0\",\"aspect-name\":\"AspectWithOperation\"},\"massages\":{\"input\":{\"$ref\":\"#/components/massages/input\"},\"output\":{\"$ref\":\"#/components/massages/output\"}}}}";
      ...
      final String expectedComponentsSchemaInput = "{\"type\":\"string\",\"description\":null}";
