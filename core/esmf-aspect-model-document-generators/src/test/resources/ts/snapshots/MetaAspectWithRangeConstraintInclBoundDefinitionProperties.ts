...
private static readonly CHARACTERISTIC_NAMESPACE = 'urn:samm:org.eclipse.esmf.samm:characteristic:2.2.0';
 ...
 public static readonly  TEST_PROPERTY = 
    ...
    getValue( object : AspectWithRangeConstraintInclBoundDefinitionProperties) : number {
        return object.testProperty;
    }

        setValue( object : AspectWithRangeConstraintInclBoundDefinitionProperties, value : number ) {
    ...
    this.NAMESPACE + 'AspectWithRangeConstraintInclBoundDefinitionProperties',
    'testProperty',
...
BoundDefinition.LESS_THAN,BoundDefinition.GREATER_THAN,new DefaultScalarValue(new DefaultScalar("http://www.w3.org/2001/XMLSchema#float" ),'2.3'),new DefaultScalarValue(new DefaultScalar("http://www.w3.org/2001/XMLSchema#float" ),'10.5'),)
