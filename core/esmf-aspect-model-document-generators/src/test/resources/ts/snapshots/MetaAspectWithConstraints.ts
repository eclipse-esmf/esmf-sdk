...
TEST_PROPERTY_WITH_DECIMAL_MIN_DECIMAL_MAX_RANGE_CONSTRAINT =
...
public static readonly
TEST_PROPERTY_WITH_DECIMAL_MAX_RANGE_CONSTRAINT =
...
public static readonly
TEST_PROPERTY_WITH_MIN_MAX_RANGE_CONSTRAINT =
    ...
    new (class extends DefaultStaticProperty<AspectWithConstraints, number> {
    ...
    })(
        {
            ...
            characteristic: new DefaultTrait({
                ...
                descriptions: [],
                see: [],
            }, new DefaultScalar('http://www.w3.org/2001/XMLSchema#int'), Units.fromName('metrePerSecond')), new ArrayList<Constraint>()
{
    {
        add(new DefaultRangeConstraint({
            isAnonymous: true,
...
public static readonly
TEST_PROPERTY_WITH_MIN_RANGE_CONSTRAINT =
...
public static readonly
TEST_PROPERTY_RANGE_CONSTRAINT_WITH_FLOAT_TYPE =
...
public static readonly
TEST_PROPERTY_RANGE_CONSTRAINT_WITH_DOUBLE_TYPE =
    ...
    new (class extends DefaultStaticProperty<AspectWithConstraints, number> {
    ...
    })(
        {
            ...
            characteristic: new DefaultTrait({
                ...
                descriptions: [],
                see: [],
            }, new DefaultScalar('http://www.w3.org/2001/XMLSchema#double'), Units.fromName('metrePerSecond')), new ArrayList<Constraint>()
{
    {
        add(new DefaultRangeConstraint({
            isAnonymous: true,
...
public static readonly
TEST_PROPERTY_WITH_MIN_MAX_LENGTH_CONSTRAINT =
...
{
    {
        add(new DefaultLengthConstraint({
            isAnonymous: true,
            preferredNames: [],
            descriptions: [],
            see: [],
...
public static readonly
TEST_PROPERTY_WITH_MIN_LENGTH_CONSTRAINT =
    ...
    new (class extends StaticContainerProperty<AspectWithConstraints, string, string[]> {
    ...
    })(
        {
            ...
            characteristic: new DefaultTrait({
                ...
                descriptions: [],
                see: [],
            }, Optional.of(new DefaultScalar('http://www.w3.org/2001/XMLSchema#nonNegativeInteger')), Optional.empty()), new ArrayList<Constraint>()
{
    {
        add(new DefaultLengthConstraint({
            isAnonymous: true,
...
getProperties();
:
Array < StaticProperty < AspectWithConstraints, any >> {
