        ...
        new (class extends DefaultStaticProperty<AspectWithGTypeForRangeConstraints, Date> {
        ...
        })(
            {
                ...
                characteristic: new DefaultTrait({
                    ...
                    descriptions: [],
                    see: [],
                }, new DefaultScalar('http://www.w3.org/2001/XMLSchema#gYear'), Units.fromName('year')), new ArrayList<Constraint>() { {
    add(
...
.
    ...
    of({
           metaModelBaseAttributes: {},
           value: _datatypeFactory.newXMLGregorianCalendarDate
    ...
    new (class extends DefaultStaticProperty<AspectWithGTypeForRangeConstraints, Date> {
    ...
    })(
        {
            ...
            characteristic: new DefaultTrait({
                ...
                descriptions: [],
                see: [],
            }, new DefaultScalar('http://www.w3.org/2001/XMLSchema#gMonth'), Units.fromName('month')), new ArrayList<Constraint>()
{
    {
    ...
    new (class extends DefaultStaticProperty<AspectWithGTypeForRangeConstraints, Date> {
    ...
    })(
        {
            ...
            characteristic: new DefaultTrait({
                ...
                descriptions: [],
                see: [],
            }, new DefaultScalar('http://www.w3.org/2001/XMLSchema#gDay'), Units.fromName('day')), new ArrayList<Constraint>()
{
    {
        add(new DefaultRangeConstraint({
            isAnonymous: true,
...
public static readonly
TEST_PROPERTY_WITH_G_YEAR_MONTH =
    ...
    new (class extends DefaultStaticProperty<AspectWithGTypeForRangeConstraints, Date> {
    ...
    })(
        {
            ...
            characteristic: new DefaultTrait({
                ...
                descriptions: [],
                see: [],
            }, new DefaultScalar('http://www.w3.org/2001/XMLSchema#gYearMonth'), Units.fromName('one')), new ArrayList<Constraint>()
{
    {
        add(new DefaultRangeConstraint({
            isAnonymous: true,
...
public static readonly
TEST_PROPERTY_WITH_G_MONTH_YEAR =
    ...
    new (class extends DefaultStaticProperty<AspectWithGTypeForRangeConstraints, Date> {
    ...
    })(
        {
            ...
            characteristic: new DefaultTrait({
                ...
                descriptions: [],
                see: [],
            }, new DefaultScalar('http://www.w3.org/2001/XMLSchema#gMonthDay'), Units.fromName('one')), new ArrayList<Constraint>()
{
    {
        add(new DefaultRangeConstraint({
            isAnonymous: true,
...
getProperties();
:
Array < StaticProperty < AspectWithGTypeForRangeConstraints, any >> {
