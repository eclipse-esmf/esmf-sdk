    ...
    new (class extends DefaultStaticProperty<AspectWithConstraint, number> {
    ...
    })(
        {
            ...
            characteristic: new DefaultTrait({
                ...
                see: [],
            }, new DefaultScalar('http://www.w3.org/2001/XMLSchema#double'), Units.fromName('metrePerSecondSquared')), new ArrayList<Constraint>()
{
    {
    ...
    new (class extends DefaultStaticProperty<AspectWithConstraint, number> {
    ...
    })(
        {
            ...
            characteristic: new DefaultTrait({
                ...
                see: [],
            }, new DefaultScalar('http://www.w3.org/2001/XMLSchema#int'), Units.fromName('metrePerSecondSquared')), new ArrayList<Constraint>()
{
    {
        add(new DefaultRangeConstraint({
            isAnonymous: true,
    ...
    new (class extends DefaultStaticProperty<AspectWithConstraint, string> {
    ...
    })(
        {
            ...
            characteristic: new DefaultTrait({
                ...
                see: [],
            }, new DefaultScalar('http://www.w3.org/2001/XMLSchema#integer'), Units.fromName('metrePerSecondSquared')), new ArrayList<Constraint>()
{
    {
        add(new DefaultRangeConstraint({
            isAnonymous: true,
    ...
    new (class extends DefaultStaticProperty<AspectWithConstraint, number> {
    ...
    })(
        {
            ...
            characteristic: new DefaultTrait({
                ...
                see: [],
            }, new DefaultScalar('http://www.w3.org/2001/XMLSchema#float'), Units.fromName('metrePerSecondSquared')), new ArrayList<Constraint>()
{
    {
        add(new DefaultRangeConstraint({
            isAnonymous: true,
...
{
    {
        add(new DefaultRegularExpressionConstraint({
            isAnonymous: true,
            preferredNames: [],
            descriptions: [],
            see: [],
...
getProperties();
:
Array < StaticProperty < AspectWithConstraint, any >> {
