...
});put(MetaReplacedAspectArtifact.TEST_LIST,new DefaultCollectionValue(new ArrayList<>() {{add(new DefaultEntityInstance({
...
descriptions : [  ],
see : [  ],
},MetaNestedEntity.INSTANCE.getProperties(),Optional.empty())));add(new DefaultEntityInstance({
...
descriptions : [  ],
see : [  ],
},MetaNestedEntity.INSTANCE.getProperties(),Optional.empty())));}},org.eclipse.esmf.metamodel.CollectionValue.CollectionType.LIST,DefaultEntity.createDefaultEntity({
urn : this.NAMESPACE + 'NestedEntity',
preferredNames : [  ],
descriptions : [  ],
see : [  ],
