...
});put(MetaReplacedAspectArtifact.NESTED_ENTITY_LIST_PROPERTY,new DefaultCollectionValue(new LinkedHashSet<>() {{add(new DefaultEntityInstance({
urn : this.NAMESPACE + 'NestedEntityInstance',
preferredNames : [  ],
descriptions : [  ],
see : [  ],
},new HashMap<Property, Value>() {{put(MetaNestedEntity.NOT_IN_PAYLOAD_PROPERTY,{
metaModelBaseAttributes : {},
value : "foo",
type : new DefaultScalar("http://www.w3.org/2001/XMLSchema#string" ),
});}},DefaultEntity.createDefaultEntity({
...
descriptions : [  ],
see : [  ],
},MetaNestedEntity.INSTANCE.getProperties(),Optional.empty())));}},org.eclipse.esmf.metamodel.CollectionValue.CollectionType.SET,DefaultEntity.createDefaultEntity({
urn : this.NAMESPACE + 'NestedEntity',
preferredNames : [  ],
descriptions : [  ],
see : [  ],
