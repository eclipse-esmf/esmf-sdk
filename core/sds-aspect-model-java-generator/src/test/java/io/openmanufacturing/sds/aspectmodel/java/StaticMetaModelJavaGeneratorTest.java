...
public class StaticMetaModelJavaGeneratorTest extends StaticMetaModelGeneratorTest {
   ...
   public void testGenerateStaticMetaModelWithOptionalProperties( final KnownVersion metaModelVersion )
         throws IOException {
      ...
      result.assertFields( "MetaAspectWithOptionalPropertiesWithEntity",
            ImmutableMap.<String, Object> builder().put( "NAMESPACE", String.class )
                                                   ...
                                                   .put( "TEST_OPTIONAL_STRING",
                                                         new TypeToken<StaticContainerProperty<String, Optional<String>>>() {
                                                         } )
                                                   .put( "TEST_OPTIONAL_ENTITY",
                                                         "StaticContainerProperty<TestEntity,Optional<TestEntity>>" )
                                                   .build(), new HashMap<>() );
      ...
      result.assertFields( "MetaTestEntity",
            ImmutableMap.<String, Object> builder().put( "NAMESPACE", String.class )
                                                   ...
                                                   .put( "TEST_SECOND_STRING",
                                                         new TypeToken<StaticProperty<String>>() {
                                                         } )
                                                   .put( "TEST_INT_LIST",
                                                         new TypeToken<StaticContainerProperty<Integer, List<Integer>>>() {
                                                         } )
                                                   .build(), new HashMap<>() );
   }
   ...
   public void testGenerateStaticMetaModelWithExtendedEnums( final KnownVersion metaModelVersion ) throws IOException {
      ...
      result.assertFields( "MetaEvaluationResult",
            ImmutableMap.<String, Object> builder().put( "NAMESPACE", String.class )
                                                   ...
                                                   .put( "AVERAGE",
                                                         new TypeToken<StaticContainerProperty<BigInteger, Optional<BigInteger>>>() {
                                                         } )
   ...
   public void testGenerateStaticMetaModelWithMeasurement( final KnownVersion metaModelVersion ) throws IOException {
      ...
      result.assertFields( "MetaAspectWithMeasurement",
            ImmutableMap.<String, Object> builder().put( "NAMESPACE", String.class )
                                                   ...
                                                   .put( "TEST_PROPERTY",
                                                         new TypeToken<StaticUnitProperty<Float>>() {
                                                         } )
                                                   .build(), new HashMap<>() );
   }
   ...
   @ParameterizedTest
   @MethodSource( value = "allVersions" )
   public void testGenerateStaticMetaModelWithRecursiveAspectWithOptional( final KnownVersion metaModelVersion )
         throws IOException {
   ...
   public void testGenerateStaticMetaModelWithDuration( final KnownVersion metaModelVersion ) throws IOException {
      ...
      result.assertFields( "MetaAspectWithDuration",
            ImmutableMap.<String, Object> builder().put( "NAMESPACE", String.class )
                                                   ...
                                                   .put( "TEST_PROPERTY",
                                                         new TypeToken<StaticUnitProperty<Integer>>() {
                                                         } )
                                                   .build(), new HashMap<>() );
   }
   ...
   @ParameterizedTest
   @MethodSource( value = "allVersions" )
   public void testGenerateStaticMetaModelWithStructuredValue( final KnownVersion metaModelVersion )
         throws IOException {
      ...
      result.assertFields( "MetaAspectWithNumericStructuredValue",
            ImmutableMap.<String, Object> builder().put( "NAMESPACE", String.class )
                                                   ...
                                                   .put( "YEAR",
                                                         new TypeToken<StaticProperty<Long>>() {
                                                         } )
                                                   .put( "MONTH",
                                                         new TypeToken<StaticProperty<Long>>() {
                                                         } )
                                                   ...
                                                   .put( "DATE",
                                                         new TypeToken<StaticProperty<XMLGregorianCalendar>>() {
                                                         } )
                                                   .build(), new HashMap<>() );
   }
   ...
   @ParameterizedTest
   @MethodSource( value = "allVersions" )
   public void testGenerateStaticMetaModelWithErrorCollection( final KnownVersion metaModelVersion )
         throws IOException {
      ...
      result.assertFields( "MetaAspectWithErrorCollection",
            ImmutableMap.<String, Object> builder().put( "NAMESPACE", String.class )
                                                   ...
                                                   .put( "ITEMS",
                                                         "StaticContainerProperty<Error,Collection<Error>>" )
                                                   .build(), new HashMap<>() );
   }

   @ParameterizedTest
   @MethodSource( value = "allVersions" )
   public void testGenerateStaticMetaModelWithCollectionAndSimpleElementCharacteristic(
      ...
      result.assertFields( "MetaAspectWithCollectionAndSimpleElementCharacteristic",
            ImmutableMap.<String, Object> builder().put( "NAMESPACE", String.class )
                                                   ...
                                                   .put( "CHARACTERISTIC_NAMESPACE", String.class )
                                                   .put( "INSTANCE",
                                                         "MetaAspectWithCollectionAndSimpleElementCharacteristic" )
                                                   .put( "ITEMS",
                                                         "StaticContainerProperty<String,Collection<String>>" )
                                                   .build(), new HashMap<>() );
   }

   @ParameterizedTest
   @MethodSource( value = "allVersions" )
   public void testGenerateStaticMetaModelWithCollectionAndElementCharacteristic( final KnownVersion metaModelVersion )
         throws IOException {
      ...
      result.assertFields( "MetaAspectWithCollectionAndElementCharacteristic",
            ImmutableMap.<String, Object> builder().put( "NAMESPACE", String.class )
                                                   ...
                                                   .put( "CHARACTERISTIC_NAMESPACE", String.class )
                                                   .put( "INSTANCE",
                                                         "MetaAspectWithCollectionAndElementCharacteristic" )
                                                   .put( "ITEMS",
                                                         "StaticContainerProperty<TestEntity,Collection<TestEntity>>" )
                                                   .build(), new HashMap<>() );
   }

   @ParameterizedTest
   @MethodSource( value = "allVersions" )
   public void testGenerateStaticMetaModelWithFixedPointConstraints( final KnownVersion metaModelVersion )
         throws IOException {
      ...
      result.assertFields( "MetaAspectWithFixedPoint",
            ImmutableMap.<String, Object> builder().put( "NAMESPACE", String.class )
                                                   ...
                                                   .put( "TEST_PROPERTY",
                                                         new TypeToken<StaticConstraintProperty<BigDecimal, DefaultFixedPointConstraint, DefaultMeasurement>>() {
                                                         } )
                                                   .build(), new HashMap<>() );
   }
   ...
   @ParameterizedTest
   @MethodSource( value = "allVersions" )
   public void testGenerateStaticMetaModelWithComplexEntityCollectionEnumeration( final KnownVersion metaModelVersion )
         throws IOException {
      ...
      result.assertFields( "MetaMyEntityOne",
            ImmutableMap.<String, Object> builder().put( "NAMESPACE", String.class )
                                                   ...
                                                   .put( "ENTITY_PROPERTY_ONE",
                                                         "StaticContainerProperty<MyEntityTwo,List<MyEntityTwo>>" )
                                                   .build(), new HashMap<>() );
   ...
   public void testCharacteristicInstantiationForEnums( final KnownVersion metaModelVersion ) throws IOException {
      ...
      final String expectedTestPropertyCharacteristicConstructorCall = "new DefaultEnumeration("
            ...
            + "Optional.of(new DefaultScalar(\"http://www.w3.org/2001/XMLSchema#int\", KnownVersion." + KnownVersion
            .getLatest() + ")), "
   ...
   public void testAspectWithBlankNode( final KnownVersion metaModelVersion ) throws IOException {
      ...
      result.assertFields( "MetaAspectWithBlankNode",
            ImmutableMap.<String, Object> builder().put( "NAMESPACE", String.class )
                                                   ...
                                                   .put( "LIST",
                                                         new TypeToken<StaticContainerProperty<String, Collection<String>>>() {
                                                         } )
                                                   .build(), new HashMap<>() );
   }
   ...
   @ParameterizedTest
   @MethodSource( value = "allVersions" )
   public void testCharacteristicInstantiationForQuantifiableWithoutUnit( final KnownVersion metaModelVersion )
         throws IOException {
   ...
   @ParameterizedTest
   @MethodSource( value = "allVersions" )
   public void testCharacteristicInstantiationForQuantifiableWithUnit( final KnownVersion metaModelVersion )
         throws IOException {
