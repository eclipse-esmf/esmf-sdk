...
public class SammDataType<T> extends BaseDatatype implements TypedRdfDatatype<T> {
   ...
   private SammDataType( final String uri, final Class<T> javaClass, final Function<String, T> parser,
   ...
   public static TypedRdfDatatype<Curie> curie( final KnownVersion metaModelVersion ) {
      ...
      return new SammDataType<>( curieUrn, Curie.class, Curie::new, Curie::getValue,
